...
# Криптиране на съобщението
"""
encrypted_message = input("Въведете криптирания текст (като списък, напр. [5, 14, 26]): ") # входа се приема като низ (string), а не като списък от числа
encrypted_message = ast.literal_eval(encrypted_message) # преобразува низа в списък
# encrypted_message = input("Въведете криптирания текст: ")
